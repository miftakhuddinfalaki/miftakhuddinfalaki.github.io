...
===============================================
-----------------------------------------------
     Kalo penasaran sama Source Code-nya 
      Langsung buka Repository nya ada
     https://github.com/kikukeii/profile
...
function cv404() {
  ...
  const getPesan = document.getElementById('pesan-cv-404')
  const showPesan = new bootstrap.Toast(getPesan)
  showPesan.show()
  const getPesan2 = document.getElementById('pesan-kontak')
  const showPesan2 = new bootstrap.Toast(getPesan2)
  showPesan2.show()
}
